...
- **Status:** ✅ Phase 0.6 + 1.1 + 1.5 + 1.6 implemented — shared types, constants, platform utils, the three XState machines, shared protocol constants, and heartbeat protocol logic, all tested (nothing imports it yet)
- **Responsibilities:**
