...
> Note: `src-tauri/plugins/pairsync-udp/` and `src-tauri/plugins/pairsync-mdns/` are **planned** (Phase 2 of `IMPLEMENTATION_PLAN.md`) — they do not exist yet.
```
...
4. **Shared Dependencies**
   ...
   - `packages/core` (domain logic) is **planned** for Phase 1+ of `IMPLEMENTATION_PLAN.md` — not yet a dependency
...
**Not yet a dependency:** `@pairsync/core` (domain logic) is planned for Phase 1+ — not installed in `apps/web`.
